...
from agents.db_tools import get_food_menu_and_voice, process_booking_tool, process_food_order_tool
...
booking_agent.register_for_function("process_booking_tool", process_booking_tool)
...
food_agent.register_for_function("get_food_menu_and_voice", get_food_menu_and_voice)
food_agent.register_for_function("process_food_order_tool", process_food_order_tool)
