...
from agents.tts_tool import tts_tool  # LangChain tool instance, only for agent use in non-webhook mode
...
if not PUBLIC_WEBHOOK_MODE:
    # Allow agents to use the real LangChain TTS tool in internal/multi-agent runs
